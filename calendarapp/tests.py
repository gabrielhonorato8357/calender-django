...
class EventListViewTests(TestCase):
    ...
    def setUp(self):
        ...
        self.all_events_url = reverse('calenderapp:all_events')  # URL for AllEventsListView
        self.running_events_url = reverse('calenderapp:running_events')  # URL for RunningEventsListView
        self.upcoming_events_url = reverse('calenderapp:upcoming_events')  # URL for UpcomingEventsListView
        self.completed_events_url = reverse('calenderapp:completed_events')  # URL for CompletedEventsListView
    ...
    def test_all_events_view(self):
        ...
        self.assertTemplateUsed(response, 'calenderapp/events_list.html')
